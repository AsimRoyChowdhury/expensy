...
<section class="bg-gray-50 dark:bg-gray-900">
    ...
    <a href="#" class="flex items-center mb-6 text-4xl font-semibold text-gray-900 dark:text-white">
          ...
          <span class='ml-1'>Expensy</span>       
      </a>
    @if ($errors->any())
    <div class="alert alert-danger">
            @foreach ($errors->all() as $error)
            <div class="flex p-4 mb-4 text-sm text-red-800 border border-red-300 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-800 dark:border-red-300">
      ...
      <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                      For Administrators: <button wire:click='admin()' class="font-medium text-primary-600 hover:underline dark:text-primary-500">Login here</button>
                  </p>
              <form class="space-y-4 md:space-y-6">
                  ...
                  <div>
                      ...
                      <input id="email" type="email" wire:model="email" name="email" value="{{ old('email') }}" placeholder="abc@example.com" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required="">
                  </div>
                  ...
                  <div>
			        ...
			        <button wire:click.prevent='login()' class="flex mx-auto mt-4 text-white bg-purple-500 border-0 py-2 px-8 focus:outline-none hover:bg-purple-600 rounded text-lg">Log In</button>
                    <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                      Not yet registered? <a href = "http://127.0.0.1:8000/register" class="font-medium text-primary-600 hover:underline dark:text-primary-500">Register</a>
                  </p>
