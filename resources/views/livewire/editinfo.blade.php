...
<div class="flex flex-col justify-center mx-auto max-w-xl w-full  lg:w-2/3 p-6 my-1  rounded-xl sm:px-12 dark:bg-gray-900 dark:text-gray-100">
	...
	<div class="space-y-4 text-center">
	  ...
	  <button class="flex text-white text-xs  border border-purple-400 py-1 px-6 focus:outline-none hover:bg-purple-600 rounded text-lg" wire:click='profile'>Return to Dashboard</button>
		</div>
        <div >
        <hr class="mt-2 border-gray-200 sm:mx-auto mx-auto w-2/3 dark:border-gray-700 " />
        @foreach($alert as $msg)
            <div class="flex p-4 mb-4 text-xs text-blue-800 border border-blue-300 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400 dark:border-blue-800" role="alert">
            ...
            @endforeach
        <form>
            <div class="flex justify-center flex-col md:justify-center">
                <input id="email1" type="email" wire:model="email" name="email" placeholder="New Email" class="flex text-gray-700 border border-purple-400 bg-white w-2/3 mb-2 mt-4  mx-auto py-2 px-2 focus:outline-none rounded text-xs ">
                <input id="username" type="text" wire:model.lazy="username" name="username" placeholder="New Username" class="flex text-gray-700 border border-purple-400 bg-white my-2 w-2/3 mx-auto py-2 px-2 focus:outline-none rounded text-xs">
                <input id="password" type="password" wire:model="password" name="password" placeholder="New Password" class="flex text-gray-700 border border-purple-400 bg-white my-2 mx-auto w-2/3 py-2 px-2 focus:outline-none rounded text-xs">
            </div>
            
        </form>
        
	</div>
    <button class="flex text-white text-xs mt-4 mx-auto border border-purple-400 py-1 px-6 focus:outline-none hover:bg-purple-600 rounded text-lg" wire:click.prevent='update()'>Save Profile</button>
	</div>
</div>
</section>
