      ...
      <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                  For Users: <button wire:click='guest()' class="font-medium text-primary-600 hover:underline dark:text-primary-500">Login here</button>
              </p>
              <form class="space-y-4 md:space-y-6">
                  ...
                  <div>
                      ...
                      <input id="admin_id" type="text" wire:model="admin_id" name="admin_id" value="{{ old('admin_id') }}" placeholder="abc@example.com" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required="">
                  </div>
